<div class="sidebar-conatnier">
    <div class="col-md-3 sidebar rightcol">
		<div class="wow_content wow_side_loggd_usr">
			<div class="wow_side_loggd_usr_cvr">
				<img src="https://agrinoble.com/upload/photos/d-cover.jpg?cache=0" alt="Kkkkkkkkkkk Cover Image">
			</div>
			<div class="wow_side_loggd_usr_hdr">
                <div class="avatar">
                    <img id="updateImage-15" alt="Kkkkkkkkkkk Profile Picture" src="https://agrinoble.com/upload/photos/d-avatar.jpg?cache=0" >
                </div>
				<div class="title">
					<a id="user-full-name" data-ajax="?link1=timeline&u=Kkkkkkkkkkk" href="https://agrinoble.com/Kkkkkkkkkkk">Kkkkkkkkkkk</a>
					<p>@Kkkkkkkkkkk</p>
				</div>
			</div>
			<ul class="wo_user_side_info">
				<li>
					<a class="menu_list" href="https://agrinoble.com/Kkkkkkkkkkk" data-ajax="?link1=timeline&u=Kkkkkkkkkkk">
						<span class="split-link"><b>des postes</b></span>
						<span id="user_post_count">0</span>
					</a>
				</li>
													<li>
						<a class="menu_list" href="https://agrinoble.com/Kkkkkkkkkkk/following" data-ajax="?link1=timeline&u=Kkkkkkkkkkk&type=following">
							<span class="split-link"><b>Suivant</b></span>
							<span>0</span>
						</a>
					</li>
					<li>
						<a class="menu_list" href="https://agrinoble.com/Kkkkkkkkkkk/followers" data-ajax="?link1=timeline&u=Kkkkkkkkkkk&type=followers">
							<span class="split-link"><b>Les adeptes</b></span>
							<span>0</span>
						</a>
					</li>
							</ul>
	...
	<div id="wo_sidebar_users">
		<div class="avatar">
			<img src="https://agrinoble.com/upload/photos/2021/03/1mpthPilt8bYi2CzrwI4_21_9c41d00492791c98a533639840846ab1_avatar.jpg?cache=0" alt="Nabil Haddadi Profile Picture"/>
		</div>
		<span class="user-popover" data-id="6" data-type="user">
			<a href="https://agrinoble.com/Nabil" data-ajax="?link1=timeline&u=Nabil" class="wo_user_link_name">
				<span class="user-name" title="Nabil Haddadi">Nabil Haddadi</span>
			</a>
		</span>
	...
	<div id="wo_sidebar_users">
		<div class="avatar">
			<img src="https://agrinoble.com/upload/photos/2021/03/nmscIGtJ92O6rB5Q1OUc_22_5e9e61b0d26a0786ff2fff581e2904bf_avatar.jpeg?cache=0" alt="Ishak Ferdi Profile Picture"/>
		</div>
		<span class="user-popover" data-id="11" data-type="user">
			<a href="https://agrinoble.com/Saber" data-ajax="?link1=timeline&u=Saber" class="wo_user_link_name">
				<span class="user-name" title="Ishak Ferdi">Ishak Ferdi</span>
			</a>
		</span>
        <div class="user-follow-button">
            <span id="Follow-11">
	...
	<div id="wo_sidebar_users">
		<div class="avatar">
			<img src="https://agrinoble.com/upload/photos/2021/03/I9BTfd1yC8977mnGpSZk_21_90ef9a508096bf1532420c3c8896c2e7_avatar.jpg?cache=0" alt="Mohamed El Amine Kabachi Profile Picture"/>
		</div>
    ...
    <div class="card hovercard promoted">
        ...
        <div class="info">
			...
			<span style="font-size: 12px;">
				3 personnes aiment ce				</span>
        </div>
		</div>
		<div class="user-follow-button">
		<span class="page_catg">Agriculture</span>
		<span id="like-1">
    <button type="button" onclick="Wo_RegisterPageLike(1)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
       ...
       <span class="button-text"> Aimer</span>
                ...
                <div class="clear"></div>
                                ...
                                <ul class="list-group">
                        <li class="list-group-item sidebar-title-back" contenteditable="false">Utilisateurs en ligne 1</li>
            <li>
                <div class="clear"></div>
            </li>
        </ul>
        ...
        <div id="sidebar-sticky">
                ...
                <li class="list-group-item text-muted sidebar-title-back" contenteditable="false">Dernières activités                                    </li>
                <li class="activities-wrapper" id="activities-wrapper">
                    <h2><div class="no-activities text-center">Pas de nouvelles activités</div><h2>                </li>
                <li>
		...
		<ul class="list-inline">
			<li><a data-ajax="?link1=terms&type=about-us" href="https://agrinoble.com/terms/about-us">Sur</a></li>
						...
						<li><a data-ajax="?link1=contact-us" href="https://agrinoble.com/contact-us">Contactez nous</a></li>
							<li><a data-ajax="?link1=developers" href="https://agrinoble.com/developers">Développeurs</a></li>
						<li>
  ...
  if ("geolocation" in navigator) {
   ...
   navigator.permissions && navigator.permissions.query({name: 'geolocation'}).then(function(PermissionStatus) {
        if(PermissionStatus.state == 'granted'){
             ...
             $('.wow_weather_icon').html('S&#039;il vous plaît activer adresse de votre navigateur pour afficher la météo actuelle.')
        }
    })
...
function setLocation(pos1, pos2) { 
    ...
    var method = 'GET';
    var app_id = "cA0NTYeq";
    var consumer_key = "dj0yJmk9QUUzRXVqNjBIT25OJmQ9WVdrOVkwRXdUbFJaWlhFbWNHbzlNQT09JnM9Y29uc3VtZXJzZWNyZXQmc3Y9MCZ4PTc2";
    var consumer_secret = "4e70173ab965d0796dc0874997795bac589c0c82";
    var unit = "f";
    var concat = '&';
    var query = {'lat': pos1,'lon':pos2,'u':unit, 'format': 'json'};
    var oauth = {
    ...
    switch(data.forecasts[0].text) {         
        ...
        case "Rain": $(".wow_weather_icon").html('<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M6,14.03A1,1 0 0,1 7,15.03C7,15.58 6.55,16.03 6,16.03C3.24,16.03 1,13.79 1,11.03C1,8.27 3.24,6.03 6,6.03C7,3.68 9.3,2.03 12,2.03C15.43,2.03 18.24,4.69 18.5,8.06L19,8.03A4,4 0 0,1 23,12.03C23,14.23 21.21,16.03 19,16.03H18C17.45,16.03 17,15.58 17,15.03C17,14.47 17.45,14.03 18,14.03H19A2,2 0 0,0 21,12.03A2,2 0 0,0 19,10.03H17V9.03C17,6.27 14.76,4.03 12,4.03C9.5,4.03 7.45,5.84 7.06,8.21C6.73,8.09 6.37,8.03 6,8.03A3,3 0 0,0 3,11.03A3,3 0 0,0 6,14.03M12,14.15C12.18,14.39 12.37,14.66 12.56,14.94C13,15.56 14,17.03 14,18C14,19.11 13.1,20 12,20A2,2 0 0,1 10,18C10,17.03 11,15.56 11.44,14.94C11.63,14.66 11.82,14.4 12,14.15M12,11.03L11.5,11.59C11.5,11.59 10.65,12.55 9.79,13.81C8.93,15.06 8,16.56 8,18A4,4 0 0,0 12,22A4,4 0 0,0 16,18C16,16.56 15.07,15.06 14.21,13.81C13.35,12.55 12.5,11.59 12.5,11.59" /></svg>>');  
          break;
        case "Scattered Showers": $(".wow_weather_icon").html('<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M6,14.03A1,1 0 0,1 7,15.03C7,15.58 6.55,16.03 6,16.03C3.24,16.03 1,13.79 1,11.03C1,8.27 3.24,6.03 6,6.03C7,3.68 9.3,2.03 12,2.03C15.43,2.03 18.24,4.69 18.5,8.06L19,8.03A4,4 0 0,1 23,12.03C23,14.23 21.21,16.03 19,16.03H18C17.45,16.03 17,15.58 17,15.03C17,14.47 17.45,14.03 18,14.03H19A2,2 0 0,0 21,12.03A2,2 0 0,0 19,10.03H17V9.03C17,6.27 14.76,4.03 12,4.03C9.5,4.03 7.45,5.84 7.06,8.21C6.73,8.09 6.37,8.03 6,8.03A3,3 0 0,0 3,11.03A3,3 0 0,0 6,14.03M12,14.15C12.18,14.39 12.37,14.66 12.56,14.94C13,15.56 14,17.03 14,18C14,19.11 13.1,20 12,20A2,2 0 0,1 10,18C10,17.03 11,15.56 11.44,14.94C11.63,14.66 11.82,14.4 12,14.15M12,11.03L11.5,11.59C11.5,11.59 10.65,12.55 9.79,13.81C8.93,15.06 8,16.56 8,18A4,4 0 0,0 12,22A4,4 0 0,0 16,18C16,16.56 15.07,15.06 14.21,13.81C13.35,12.55 12.5,11.59 12.5,11.59" /></svg>>');  
          break;
