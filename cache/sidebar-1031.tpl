<div class="sidebar-conatnier">
    <div class="col-md-3 sidebar rightcol">
		<div class="wow_content wow_side_loggd_usr">
			<div class="wow_side_loggd_usr_cvr">
				<img src="https://agrinoblelive.s3.amazonaws.com/upload/photos/d-cover.jpg?cache=0" alt="hassan Sad Cover Image">
			</div>
			<div class="wow_side_loggd_usr_hdr">
                <div class="avatar">
                    <img id="updateImage-1031" alt="hassan Sad Profile Picture" src="https://agrinoblelive.s3.amazonaws.com/upload/photos/d-avatar.jpg?cache=0" >
                </div>
				<div class="title">
					<a id="user-full-name" data-ajax="?link1=timeline&u=Hassani" href="https://agrinoble.com/Hassani">hassan Sad</a>
					<p>@Hassani</p>
				</div>
			</div>
			<ul class="wo_user_side_info">
				<li>
					<a class="menu_list" href="https://agrinoble.com/Hassani" data-ajax="?link1=timeline&u=Hassani">
						<span class="split-link"><b>posts</b></span>
						<span id="user_post_count">0</span>
					</a>
				</li>
													<li>
						<a class="menu_list" href="https://agrinoble.com/Hassani/following" data-ajax="?link1=timeline&u=Hassani&type=following">
							<span class="split-link"><b>Followers</b></span>
							<span>0</span>
						</a>
					</li>
					<li>
						<a class="menu_list" href="https://agrinoble.com/Hassani/followers" data-ajax="?link1=timeline&u=Hassani&type=followers">
	...
	<div id="wo_sidebar_users">
		<div class="avatar">
			<img src="https://agrinoblelive.s3.amazonaws.com/upload/photos/d-avatar.jpg?cache=0" alt="garanjing Profile Picture"/>
		</div>
		<span class="user-popover" data-id="945" data-type="user">
			<a href="https://agrinoble.com/garanjing" data-ajax="?link1=timeline&u=garanjing" class="wo_user_link_name">
				<span class="user-name" title="garanjing">garanjing</span>
			</a>
		</span>
        <div class="user-follow-button">
            <span id="Follow-945">
    <button type="button" onclick="Wo_RegisterFollow(945, 0)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
	...
	<div id="wo_sidebar_users">
		<div class="avatar">
			<img src="https://agrinoblelive.s3.amazonaws.com/upload/photos/d-avatar.jpg?cache=0" alt="Nuaiman Profile Picture"/>
		</div>
		<span class="user-popover" data-id="866" data-type="user">
			<a href="https://agrinoble.com/Nuaiman" data-ajax="?link1=timeline&u=Nuaiman" class="wo_user_link_name">
				<span class="user-name" title="Nuaiman">Nuaiman</span>
			</a>
		</span>
        <div class="user-follow-button">
            <span id="Follow-866">
    <button type="button" onclick="Wo_RegisterFollow(866, 0)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="20" y1="8" x2="20" y2="14"></line><line x1="23" y1="11" x2="17" y2="11"></line></svg>
       <span class="button-text"> Follow</span>
    </button>
</span>        </div>
	...
	<div id="wo_sidebar_users">
		<div class="avatar">
			<img src="https://agrinoblelive.s3.amazonaws.com/upload/photos/f-avatar.jpg?cache=0" alt="Alekasaputra Profile Picture"/>
		</div>
		<span class="user-popover" data-id="938" data-type="user">
			<a href="https://agrinoble.com/Alekasaputra" data-ajax="?link1=timeline&u=Alekasaputra" class="wo_user_link_name">
				<span class="user-name" title="Alekasaputra">Alekasaputra</span>
			</a>
		</span>
        <div class="user-follow-button">
            <span id="Follow-938">
    <button type="button" onclick="Wo_RegisterFollow(938, 0)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="20" y1="8" x2="20" y2="14"></line><line x1="23" y1="11" x2="17" y2="11"></line></svg>
       <span class="button-text"> Follow</span>
    </button>
</span>        </div>
	...
	<div id="wo_sidebar_users">
		<div class="avatar">
			<img src="https://agrinoblelive.s3.amazonaws.com/upload/photos/2021/08/N5iKfnhSn8aVHqyMuZgG_10_4e0297a4edcb684d4b271498a9f4f80c_avatar.jpg?cache=0" alt="Mohamd afef Profile Picture"/>
		</div>
		<span class="user-popover" data-id="416" data-type="user">
			<a href="https://agrinoble.com/mohamedafef" data-ajax="?link1=timeline&u=mohamedafef" class="wo_user_link_name">
				<span class="user-name" title="Mohamd afef">Mohamd afef</span>
			</a>
		</span>
        <div class="user-follow-button">
            <span id="Follow-416">
    <button type="button" onclick="Wo_RegisterFollow(416, 0)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="20" y1="8" x2="20" y2="14"></line><line x1="23" y1="11" x2="17" y2="11"></line></svg>
       <span class="button-text"> Follow</span>
    </button>
</span>        </div>
