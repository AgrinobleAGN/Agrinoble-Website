    ...
    <div class="col-md-3 sidebar rightcol">
		<div class="wow_content wow_side_loggd_usr">
			<div class="wow_side_loggd_usr_cvr">
				<img src="https://agrinoblelive.s3.amazonaws.com/upload/photos/d-cover.jpg?cache=0" alt="Valdeci Gomes dos Santos Cover Image">
			</div>
			<div class="wow_side_loggd_usr_hdr">
                <div class="avatar">
                    <img id="updateImage-77" alt="Valdeci Gomes dos Santos Profile Picture" src="https://agrinoblelive.s3.amazonaws.com/upload/photos/2021/06/VLdRuZ1MplAUKPSIopU6_09_68d7f8824a01df3187d582f9aee9e8d1_avatar.jpg?cache=0" >
                </div>
				<div class="title">
					<a id="user-full-name" data-ajax="?link1=timeline&u=Valdec66" href="https://agrinoble.com/Valdec66">Valdeci Gomes dos Santos</a>
					<p>@Valdec66</p>
				</div>
			</div>
			<ul class="wo_user_side_info">
				<li>
					<a class="menu_list" href="https://agrinoble.com/Valdec66" data-ajax="?link1=timeline&u=Valdec66">
						<span class="split-link"><b>posts</b></span>
						<span id="user_post_count">1</span>
					</a>
				</li>
													<li>
						<a class="menu_list" href="https://agrinoble.com/Valdec66/following" data-ajax="?link1=timeline&u=Valdec66&type=following">
							<span class="split-link"><b>Followers</b></span>
							<span>0</span>
						</a>
					</li>
					<li>
						<a class="menu_list" href="https://agrinoble.com/Valdec66/followers" data-ajax="?link1=timeline&u=Valdec66&type=followers">
