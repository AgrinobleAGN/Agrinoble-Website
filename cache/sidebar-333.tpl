    ...
    <div class="col-md-3 sidebar rightcol">
		<div class="wow_content wow_side_loggd_usr">
			<div class="wow_side_loggd_usr_cvr">
				<img src="https://agrinoblelive.s3.amazonaws.com/upload/photos/d-cover.jpg?cache=0" alt="MOINBEWA Cover Image">
			</div>
			<div class="wow_side_loggd_usr_hdr">
                <div class="avatar">
                    <img id="updateImage-333" alt="MOINBEWA Profile Picture" src="https://agrinoblelive.s3.amazonaws.com/upload/photos/d-avatar.jpg?cache=0" >
                </div>
				<div class="title">
					<a id="user-full-name" data-ajax="?link1=timeline&u=MOINBEWA" href="https://agrinoble.com/MOINBEWA">MOINBEWA</a>
					<p>@MOINBEWA</p>
				</div>
			</div>
			<ul class="wo_user_side_info">
				<li>
					<a class="menu_list" href="https://agrinoble.com/MOINBEWA" data-ajax="?link1=timeline&u=MOINBEWA">
						<span class="split-link"><b>posts</b></span>
						<span id="user_post_count">0</span>
					</a>
				</li>
													<li>
						<a class="menu_list" href="https://agrinoble.com/MOINBEWA/following" data-ajax="?link1=timeline&u=MOINBEWA&type=following">
							<span class="split-link"><b>Followers</b></span>
							<span>0</span>
						</a>
					</li>
					<li>
						<a class="menu_list" href="https://agrinoble.com/MOINBEWA/followers" data-ajax="?link1=timeline&u=MOINBEWA&type=followers">
