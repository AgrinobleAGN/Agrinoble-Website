<div class="sidebar-conatnier">
    <div class="col-md-3 sidebar rightcol">
		<div class="wow_content wow_side_loggd_usr">
			<div class="wow_side_loggd_usr_cvr">
				<img src="https://agrinoblelive.s3.amazonaws.com/upload/photos/d-cover.jpg?cache=0" alt="Gentian Kolonja Cover Image">
			</div>
			<div class="wow_side_loggd_usr_hdr">
                <div class="avatar">
                    <img id="updateImage-1046" alt="Gentian Kolonja Profile Picture" src="https://agrinoblelive.s3.amazonaws.com/upload/photos/2021/08/EfUAvYtDnOWCCid89CA8_avatar.jpg?cache=0" >
                </div>
				<div class="title">
					<a id="user-full-name" data-ajax="?link1=timeline&u=d19a266e5" href="https://agrinoble.com/d19a266e5">Gentian Kolonja</a>
					<p>@d19a266e5</p>
				</div>
			</div>
			<ul class="wo_user_side_info">
				<li>
					<a class="menu_list" href="https://agrinoble.com/d19a266e5" data-ajax="?link1=timeline&u=d19a266e5">
						<span class="split-link"><b>posts</b></span>
						<span id="user_post_count">0</span>
					</a>
				</li>
													<li>
						<a class="menu_list" href="https://agrinoble.com/d19a266e5/following" data-ajax="?link1=timeline&u=d19a266e5&type=following">
							<span class="split-link"><b>Followers</b></span>
							<span>0</span>
						</a>
					</li>
					<li>
						<a class="menu_list" href="https://agrinoble.com/d19a266e5/followers" data-ajax="?link1=timeline&u=d19a266e5&type=followers">
	...
	<div id="wo_sidebar_users">
		<div class="avatar">
			<img src="https://agrinoblelive.s3.amazonaws.com/upload/photos/2021/08/te42BbdWS481qNsBvdvU_17_0f5fd5a6dcb4c338cebe5a387bd9e346_avatar.jpg?cache=0" alt="Ram Dani Profile Picture"/>
		</div>
		<span class="user-popover" data-id="875" data-type="user">
			<a href="https://agrinoble.com/Ramdani" data-ajax="?link1=timeline&u=Ramdani" class="wo_user_link_name">
				<span class="user-name" title="Ram Dani">Ram Dani</span>
			</a>
		</span>
        <div class="user-follow-button">
            <span id="Follow-875">
    <button type="button" onclick="Wo_RegisterFollow(875, 0)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
