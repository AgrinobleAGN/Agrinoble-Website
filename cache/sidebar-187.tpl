    ...
    <div class="col-md-3 sidebar rightcol">
		<div class="wow_content wow_side_loggd_usr">
			<div class="wow_side_loggd_usr_cvr">
				<img src="https://agrinoblelive.s3.amazonaws.com/upload/photos/d-cover.jpg?cache=0" alt="Fethi Bounour Cover Image">
			</div>
			<div class="wow_side_loggd_usr_hdr">
                <div class="avatar">
                    <img id="updateImage-187" alt="Fethi Bounour Profile Picture" src="https://agrinoblelive.s3.amazonaws.com/upload/photos/d-avatar.jpg?cache=0" >
                </div>
				<div class="title">
					<a id="user-full-name" data-ajax="?link1=timeline&u=Rihamabir" href="https://agrinoble.com/Rihamabir">Fethi Bounour</a>
					<p>@Rihamabir</p>
				</div>
			</div>
			<ul class="wo_user_side_info">
				<li>
					<a class="menu_list" href="https://agrinoble.com/Rihamabir" data-ajax="?link1=timeline&u=Rihamabir">
						<span class="split-link"><b>posts</b></span>
						<span id="user_post_count">0</span>
					</a>
				</li>
													<li>
						<a class="menu_list" href="https://agrinoble.com/Rihamabir/following" data-ajax="?link1=timeline&u=Rihamabir&type=following">
							<span class="split-link"><b>Followers</b></span>
							<span>2</span>
						</a>
					</li>
					<li>
						<a class="menu_list" href="https://agrinoble.com/Rihamabir/followers" data-ajax="?link1=timeline&u=Rihamabir&type=followers">
