<div class="sidebar-conatnier">
    <div class="col-md-3 sidebar rightcol">
		<div class="wow_content wow_side_loggd_usr">
			<div class="wow_side_loggd_usr_cvr">
				<img src="https://agrinoblelive.s3.amazonaws.com/upload/photos/d-cover.jpg?cache=0" alt="Lucky89 Cover Image">
			</div>
			<div class="wow_side_loggd_usr_hdr">
                <div class="avatar">
                    <img id="updateImage-889" alt="Lucky89 Profile Picture" src="https://agrinoblelive.s3.amazonaws.com/upload/photos/2021/08/2jTRoygc22gD1hpEx9tr_17_1ad3664bd48c2ae7c6e5291f15bcf481_avatar.jpeg?cache=0" >
                </div>
				<div class="title">
					<a id="user-full-name" data-ajax="?link1=timeline&u=Lucky89" href="https://agrinoble.com/Lucky89">Lucky89</a>
					<p>@Lucky89</p>
				</div>
			</div>
			<ul class="wo_user_side_info">
				<li>
					<a class="menu_list" href="https://agrinoble.com/Lucky89" data-ajax="?link1=timeline&u=Lucky89">
						<span class="split-link"><b>posts</b></span>
						<span id="user_post_count">1</span>
					</a>
				</li>
													<li>
						<a class="menu_list" href="https://agrinoble.com/Lucky89/following" data-ajax="?link1=timeline&u=Lucky89&type=following">
							<span class="split-link"><b>Followers</b></span>
							<span>0</span>
						</a>
					</li>
					<li>
						<a class="menu_list" href="https://agrinoble.com/Lucky89/followers" data-ajax="?link1=timeline&u=Lucky89&type=followers">
	...
	<div id="wo_sidebar_users">
		<div class="avatar">
			<img src="https://agrinoblelive.s3.amazonaws.com/upload/photos/2021/08/aPmxhNHX7rRxa96Cezqi_12_344dddcd056147053cf64dba53ca1878_avatar.jpg?cache=0" alt="shazly mohameed Profile Picture"/>
		</div>
		<span class="user-popover" data-id="601" data-type="user">
			<a href="https://agrinoble.com/shazlym" data-ajax="?link1=timeline&u=shazlym" class="wo_user_link_name">
				<span class="user-name" title="shazly mohameed">shazly mohameed</span>
			</a>
		</span>
        <div class="user-follow-button">
            <span id="Follow-601">
    <button type="button" onclick="Wo_RegisterFollow(601, 0)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
	...
	<div id="wo_sidebar_users">
		<div class="avatar">
			<img src="https://agrinoblelive.s3.amazonaws.com/upload/photos/d-avatar.jpg?cache=0" alt="memo0921 Profile Picture"/>
		</div>
		<span class="user-popover" data-id="1055" data-type="user">
			<a href="https://agrinoble.com/memo0921" data-ajax="?link1=timeline&u=memo0921" class="wo_user_link_name">
				<span class="user-name" title="memo0921">memo0921</span>
			</a>
		</span>
        <div class="user-follow-button">
            <span id="Follow-1055">
    <button type="button" onclick="Wo_RegisterFollow(1055, 0)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="20" y1="8" x2="20" y2="14"></line><line x1="23" y1="11" x2="17" y2="11"></line></svg>
       <span class="button-text"> Follow</span>
    </button>
</span>        </div>
