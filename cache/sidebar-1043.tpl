<div class="sidebar-conatnier">
    <div class="col-md-3 sidebar rightcol">
		<div class="wow_content wow_side_loggd_usr">
			<div class="wow_side_loggd_usr_cvr">
				<img src="https://agrinoblelive.s3.amazonaws.com/upload/photos/d-cover.jpg?cache=0" alt="Thiago Gonçalves Cover Image">
			</div>
			<div class="wow_side_loggd_usr_hdr">
                <div class="avatar">
                    <img id="updateImage-1043" alt="Thiago Gonçalves Profile Picture" src="https://agrinoblelive.s3.amazonaws.com/upload/photos/2021/08/BBJpGkMUg8ESy2NPaOmE_20_56cc9d52cc0f65d733174ecf32d0df32_avatar.jpg?cache=0" >
                </div>
				<div class="title">
					<a id="user-full-name" data-ajax="?link1=timeline&u=thiagofono" href="https://agrinoble.com/thiagofono">Thiago Gonçalves</a>
					<p>@thiagofono</p>
				</div>
			</div>
			<ul class="wo_user_side_info">
				<li>
					<a class="menu_list" href="https://agrinoble.com/thiagofono" data-ajax="?link1=timeline&u=thiagofono">
						<span class="split-link"><b>posts</b></span>
						<span id="user_post_count">0</span>
					</a>
				</li>
													<li>
						<a class="menu_list" href="https://agrinoble.com/thiagofono/following" data-ajax="?link1=timeline&u=thiagofono&type=following">
							<span class="split-link"><b>Followers</b></span>
							<span>0</span>
						</a>
					</li>
					<li>
						<a class="menu_list" href="https://agrinoble.com/thiagofono/followers" data-ajax="?link1=timeline&u=thiagofono&type=followers">
	...
	<div id="wo_sidebar_users">
		<div class="avatar">
			<img src="https://agrinoblelive.s3.amazonaws.com/upload/photos/f-avatar.jpg?cache=0" alt="Pepi990 Profile Picture"/>
		</div>
		<span class="user-popover" data-id="123" data-type="user">
			<a href="https://agrinoble.com/Pepi990" data-ajax="?link1=timeline&u=Pepi990" class="wo_user_link_name">
				<span class="user-name" title="Pepi990">Pepi990</span>
			</a>
		</span>
        <div class="user-follow-button">
            <span id="Follow-123">
    <button type="button" onclick="Wo_RegisterFollow(123, 0)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
	...
	<div id="wo_sidebar_users">
		<div class="avatar">
			<img src="https://agrinoblelive.s3.amazonaws.com/upload/photos/d-avatar.jpg?cache=0" alt="Nguyen Anh Tuan Profile Picture"/>
		</div>
		<span class="user-popover" data-id="825" data-type="user">
			<a href="https://agrinoble.com/MMC_finance" data-ajax="?link1=timeline&u=MMC_finance" class="wo_user_link_name">
				<span class="user-name" title="Nguyen Anh Tuan">Nguyen Anh Tuan</span>
			</a>
		</span>
        <div class="user-follow-button">
            <span id="Follow-825">
    <button type="button" onclick="Wo_RegisterFollow(825, 0)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="20" y1="8" x2="20" y2="14"></line><line x1="23" y1="11" x2="17" y2="11"></line></svg>
       <span class="button-text"> Follow</span>
    </button>
</span>        </div>
