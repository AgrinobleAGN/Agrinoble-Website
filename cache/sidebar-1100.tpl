<div class="sidebar-conatnier">
    <div class="col-md-3 sidebar rightcol">
		<div class="wow_content wow_side_loggd_usr">
			<div class="wow_side_loggd_usr_cvr">
				<img src="https://agrinoblelive.s3.amazonaws.com/upload/photos/d-cover.jpg?cache=0" alt="sixtus obunike Cover Image">
			</div>
			<div class="wow_side_loggd_usr_hdr">
                <div class="avatar">
                    <img id="updateImage-1100" alt="sixtus obunike Profile Picture" src="https://agrinoblelive.s3.amazonaws.com/upload/photos/2021/08/dy1c5HZidv9pC8vVuHT1_22_11c0527378dd5a863342c8c17f191401_avatar.jpg?cache=0" >
                </div>
				<div class="title">
					<a id="user-full-name" data-ajax="?link1=timeline&u=sirbrown" href="https://agrinoble.com/sirbrown">sixtus obunike</a>
					<p>@sirbrown</p>
				</div>
			</div>
			<ul class="wo_user_side_info">
				<li>
					<a class="menu_list" href="https://agrinoble.com/sirbrown" data-ajax="?link1=timeline&u=sirbrown">
						<span class="split-link"><b>posts</b></span>
						<span id="user_post_count">1</span>
					</a>
				</li>
													<li>
						<a class="menu_list" href="https://agrinoble.com/sirbrown/following" data-ajax="?link1=timeline&u=sirbrown&type=following">
							<span class="split-link"><b>Followers</b></span>
							<span>1</span>
						</a>
					</li>
					<li>
						<a class="menu_list" href="https://agrinoble.com/sirbrown/followers" data-ajax="?link1=timeline&u=sirbrown&type=followers">
	...
	<div id="wo_sidebar_users">
		<div class="avatar">
			<img src="https://agrinoblelive.s3.amazonaws.com/upload/photos/d-avatar.jpg?cache=0" alt="loki31 Profile Picture"/>
		</div>
		<span class="user-popover" data-id="893" data-type="user">
			<a href="https://agrinoble.com/loki31" data-ajax="?link1=timeline&u=loki31" class="wo_user_link_name">
				<span class="user-name" title="loki31">loki31</span>
			</a>
		</span>
        <div class="user-follow-button">
            <span id="Follow-893">
    <button type="button" onclick="Wo_RegisterFollow(893, 0)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="20" y1="8" x2="20" y2="14"></line><line x1="23" y1="11" x2="17" y2="11"></line></svg>
       <span class="button-text"> Follow</span>
    </button>
</span>        </div>
	...
	<div id="wo_sidebar_users">
		<div class="avatar">
			<img src="https://agrinoblelive.s3.amazonaws.com/upload/photos/2021/08/qygdZoOhrDS7IQlrEQlb_18_4e1701b0d16ef821af6bb5ee659eeac7_avatar.jpg?cache=0" alt="Mhd Efendi Profile Picture"/>
		</div>
		<span class="user-popover" data-id="927" data-type="user">
			<a href="https://agrinoble.com/mhdefendi" data-ajax="?link1=timeline&u=mhdefendi" class="wo_user_link_name">
				<span class="user-name" title="Mhd Efendi">Mhd Efendi</span>
			</a>
		</span>
        <div class="user-follow-button">
            <span id="Follow-927">
    <button type="button" onclick="Wo_RegisterFollow(927, 0)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="20" y1="8" x2="20" y2="14"></line><line x1="23" y1="11" x2="17" y2="11"></line></svg>
       <span class="button-text"> Follow</span>
    </button>
</span>        </div>
	...
	<div id="wo_sidebar_users">
		<div class="avatar">
			<img src="https://agrinoblelive.s3.amazonaws.com/upload/photos/d-avatar.jpg?cache=0" alt="rezakhalili Profile Picture"/>
		</div>
		<span class="user-popover" data-id="820" data-type="user">
			<a href="https://agrinoble.com/rezakhalili" data-ajax="?link1=timeline&u=rezakhalili" class="wo_user_link_name">
				<span class="user-name" title="rezakhalili">rezakhalili</span>
			</a>
		</span>
        <div class="user-follow-button">
            <span id="Follow-820">
    <button type="button" onclick="Wo_RegisterFollow(820, 0)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="20" y1="8" x2="20" y2="14"></line><line x1="23" y1="11" x2="17" y2="11"></line></svg>
       <span class="button-text"> Follow</span>
    </button>
</span>        </div>
