    ...
    <div class="col-md-3 sidebar rightcol">
		<div class="wow_content wow_side_loggd_usr">
			<div class="wow_side_loggd_usr_cvr">
				<img src="https://agrinoblelive.s3.amazonaws.com/upload/photos/d-cover.jpg?cache=0" alt="Kyla Rabano Cover Image">
			</div>
			<div class="wow_side_loggd_usr_hdr">
                <div class="avatar">
                    <img id="updateImage-63" alt="Kyla Rabano Profile Picture" src="https://agrinoblelive.s3.amazonaws.com/upload/photos/2021/05/Z2qszYtXsGAB5NgUFwVW_21_9469460e377d663b2aebfcdd6f48d10e_avatar.jpeg?cache=0" >
                </div>
				<div class="title">
					<a id="user-full-name" data-ajax="?link1=timeline&u=KylaRabano" href="https://agrinoble.com/KylaRabano">Kyla Rabano</a>
					<p>@KylaRabano</p>
				</div>
			</div>
			<ul class="wo_user_side_info">
				<li>
					<a class="menu_list" href="https://agrinoble.com/KylaRabano" data-ajax="?link1=timeline&u=KylaRabano">
						<span class="split-link"><b>posts</b></span>
						<span id="user_post_count">1</span>
					</a>
				</li>
													<li>
						<a class="menu_list" href="https://agrinoble.com/KylaRabano/following" data-ajax="?link1=timeline&u=KylaRabano&type=following">
							<span class="split-link"><b>Followers</b></span>
							<span>0</span>
						</a>
					</li>
					<li>
						<a class="menu_list" href="https://agrinoble.com/KylaRabano/followers" data-ajax="?link1=timeline&u=KylaRabano&type=followers">
