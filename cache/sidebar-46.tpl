    ...
    <div class="col-md-3 sidebar rightcol">
		<div class="wow_content wow_side_loggd_usr">
			<div class="wow_side_loggd_usr_cvr">
				<img src="https://agrinoblelive.s3.amazonaws.com/upload/photos/d-cover.jpg?cache=0" alt="Rajwant Singh Cover Image">
			</div>
			<div class="wow_side_loggd_usr_hdr">
                <div class="avatar">
                    <img id="updateImage-46" alt="Rajwant Singh Profile Picture" src="https://agrinoblelive.s3.amazonaws.com/upload/photos/2021/04/EzIAOzAxGusymNStQBOe_28_7b123357b30c2db53a94e2363319a8aa_avatar.png?cache=0" >
                </div>
				<div class="title">
					<a id="user-full-name" data-ajax="?link1=timeline&u=rajwantsingh" href="https://agrinoble.com/rajwantsingh">Rajwant Singh</a>
					<p>@rajwantsingh</p>
				</div>
			</div>
			<ul class="wo_user_side_info">
				<li>
					<a class="menu_list" href="https://agrinoble.com/rajwantsingh" data-ajax="?link1=timeline&u=rajwantsingh">
						<span class="split-link"><b>posts</b></span>
						<span id="user_post_count">1</span>
					</a>
				</li>
													<li>
						<a class="menu_list" href="https://agrinoble.com/rajwantsingh/following" data-ajax="?link1=timeline&u=rajwantsingh&type=following">
							<span class="split-link"><b>Followers</b></span>
							<span>3</span>
						</a>
					</li>
					<li>
						<a class="menu_list" href="https://agrinoble.com/rajwantsingh/followers" data-ajax="?link1=timeline&u=rajwantsingh&type=followers">
