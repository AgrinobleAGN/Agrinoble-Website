    ...
    <div class="col-md-3 sidebar rightcol">
		<div class="wow_content wow_side_loggd_usr">
			<div class="wow_side_loggd_usr_cvr">
				<img src="https://agrinoblelive.s3.amazonaws.com/upload/photos/d-cover.jpg?cache=0" alt="San Ish Cover Image">
			</div>
			<div class="wow_side_loggd_usr_hdr">
                <div class="avatar">
                    <img id="updateImage-59" alt="San Ish Profile Picture" src="https://agrinoblelive.s3.amazonaws.com/upload/photos/2021/05/cKm5ixU6mI1tkfNnmUhP_avatar.jpg?cache=0" >
                </div>
				<div class="title">
					<a id="user-full-name" data-ajax="?link1=timeline&u=772f5f9eb" href="https://agrinoble.com/772f5f9eb">San Ish</a>
					<p>@772f5f9eb</p>
				</div>
			</div>
			<ul class="wo_user_side_info">
				<li>
					<a class="menu_list" href="https://agrinoble.com/772f5f9eb" data-ajax="?link1=timeline&u=772f5f9eb">
						<span class="split-link"><b>posts</b></span>
						<span id="user_post_count">0</span>
					</a>
				</li>
													<li>
						<a class="menu_list" href="https://agrinoble.com/772f5f9eb/following" data-ajax="?link1=timeline&u=772f5f9eb&type=following">
							<span class="split-link"><b>Followers</b></span>
							<span>0</span>
						</a>
					</li>
					<li>
						<a class="menu_list" href="https://agrinoble.com/772f5f9eb/followers" data-ajax="?link1=timeline&u=772f5f9eb&type=followers">
