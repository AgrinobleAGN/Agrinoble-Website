<div class="sidebar-conatnier">
    <div class="col-md-3 sidebar rightcol">
		<div class="wow_content wow_side_loggd_usr">
			<div class="wow_side_loggd_usr_cvr">
				<img src="https://agrinoblelive.s3.amazonaws.com/upload/photos/d-cover.jpg?cache=0" alt="Adam Barness Cover Image">
			</div>
			<div class="wow_side_loggd_usr_hdr">
                <div class="avatar">
                    <img id="updateImage-1064" alt="Adam Barness Profile Picture" src="https://agrinoblelive.s3.amazonaws.com/upload/photos/d-avatar.jpg?cache=0" >
                </div>
				<div class="title">
					<a id="user-full-name" data-ajax="?link1=timeline&u=AdamBarness" href="https://agrinoble.com/AdamBarness">Adam Barness</a>
					<p>@AdamBarness</p>
				</div>
			</div>
			<ul class="wo_user_side_info">
				<li>
					<a class="menu_list" href="https://agrinoble.com/AdamBarness" data-ajax="?link1=timeline&u=AdamBarness">
						<span class="split-link"><b>posts</b></span>
						<span id="user_post_count">0</span>
					</a>
				</li>
													<li>
						<a class="menu_list" href="https://agrinoble.com/AdamBarness/following" data-ajax="?link1=timeline&u=AdamBarness&type=following">
							<span class="split-link"><b>Followers</b></span>
							<span>0</span>
						</a>
					</li>
					<li>
						<a class="menu_list" href="https://agrinoble.com/AdamBarness/followers" data-ajax="?link1=timeline&u=AdamBarness&type=followers">
	...
	<div id="wo_sidebar_users">
		<div class="avatar">
			<img src="https://agrinoblelive.s3.amazonaws.com/upload/photos/d-avatar.jpg?cache=0" alt="zawzawthet Profile Picture"/>
		</div>
		<span class="user-popover" data-id="1019" data-type="user">
			<a href="https://agrinoble.com/zawzawthet" data-ajax="?link1=timeline&u=zawzawthet" class="wo_user_link_name">
				<span class="user-name" title="zawzawthet">zawzawthet</span>
			</a>
		</span>
        <div class="user-follow-button">
            <span id="Follow-1019">
    <button type="button" onclick="Wo_RegisterFollow(1019, 0)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="20" y1="8" x2="20" y2="14"></line><line x1="23" y1="11" x2="17" y2="11"></line></svg>
       <span class="button-text"> Follow</span>
    </button>
</span>        </div>
