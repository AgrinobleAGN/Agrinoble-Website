    ...
    <div class="col-md-3 sidebar rightcol">
		<div class="wow_content wow_side_loggd_usr">
			<div class="wow_side_loggd_usr_cvr">
				<img src="https://agrinoble.com/upload/photos/d-cover.jpg?cache=0" alt="Kabab Cover Image">
			</div>
			<div class="wow_side_loggd_usr_hdr">
                <div class="avatar">
                    <img id="updateImage-10" alt="Kabab Profile Picture" src="https://agrinoble.com/upload/photos/f-avatar.jpg?cache=0" >
                </div>
				<div class="title">
					<a id="user-full-name" data-ajax="?link1=timeline&u=Kabab" href="https://agrinoble.com/Kabab">Kabab</a>
					<p>@Kabab</p>
				</div>
			</div>
			<ul class="wo_user_side_info">
				<li>
					<a class="menu_list" href="https://agrinoble.com/Kabab" data-ajax="?link1=timeline&u=Kabab">
						<span class="split-link"><b>des postes</b></span>
						<span id="user_post_count">0</span>
					</a>
				</li>
													<li>
						<a class="menu_list" href="https://agrinoble.com/Kabab/following" data-ajax="?link1=timeline&u=Kabab&type=following">
							<span class="split-link"><b>Suivant</b></span>
							<span>0</span>
						</a>
					</li>
					<li>
						<a class="menu_list" href="https://agrinoble.com/Kabab/followers" data-ajax="?link1=timeline&u=Kabab&type=followers">
			...
			<li class="list-group-item sidebar-title-back" contenteditable="false">
									<a class="pro-me-here pull-right" href="https://agrinoble.com/go-pro">Me mettre ici</a>
								Membres Pro			</li>
			<ul class="list-inline wo_pro_users">
						<li>
	<a class="user" href="https://agrinoble.com/kabachi" data-ajax="?link1=timeline&u=kabachi" title="Mohamed El Amine Kabachi">
		<img alt="Mohamed El Amine Kabachi" src="https://agrinoble.com/upload/photos/2021/03/I9BTfd1yC8977mnGpSZk_21_90ef9a508096bf1532420c3c8896c2e7_avatar.jpg?cache=0" />
		<span>Mohamed El Amine Kabachi</span>
	</a>
</li> 			</ul>
		</div>
				...
				<div class="dropdown dropup sun_foot_drop_menu">
					...
					<ul class="dropdown-menu dropdown-menu-right" role="menu">
						...
						<li><a data-ajax="?link1=terms&type=terms" href="https://agrinoble.com/terms/terms">Conditions d&#39;utilisation</a></li>
													<li><a data-ajax="?link1=terms&type=refund" href="https://agrinoble.com/terms/refund">Demande de remboursement</a></li>
																	</ul>
				</div>
			</li> 
		</ul>
