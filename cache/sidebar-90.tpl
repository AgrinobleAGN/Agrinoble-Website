    ...
    <div class="col-md-3 sidebar rightcol">
		<div class="wow_content wow_side_loggd_usr">
			<div class="wow_side_loggd_usr_cvr">
				<img src="https://agrinoblelive.s3.amazonaws.com/upload/photos/d-cover.jpg?cache=0" alt="Saeed Shadkam Cover Image">
			</div>
			<div class="wow_side_loggd_usr_hdr">
                <div class="avatar">
                    <img id="updateImage-90" alt="Saeed Shadkam Profile Picture" src="https://agrinoblelive.s3.amazonaws.com/upload/photos/2021/07/P1LhbCN8ro6IFARQruFP_avatar.jpg?cache=0" >
                </div>
				<div class="title">
					<a id="user-full-name" data-ajax="?link1=timeline&u=33169fc09" href="https://agrinoble.com/33169fc09">Saeed Shadkam</a>
					<p>@33169fc09</p>
				</div>
			</div>
			<ul class="wo_user_side_info">
				<li>
					<a class="menu_list" href="https://agrinoble.com/33169fc09" data-ajax="?link1=timeline&u=33169fc09">
						<span class="split-link"><b>posts</b></span>
						<span id="user_post_count">0</span>
					</a>
				</li>
													<li>
						<a class="menu_list" href="https://agrinoble.com/33169fc09/following" data-ajax="?link1=timeline&u=33169fc09&type=following">
							<span class="split-link"><b>Followers</b></span>
							<span>0</span>
						</a>
					</li>
					<li>
						<a class="menu_list" href="https://agrinoble.com/33169fc09/followers" data-ajax="?link1=timeline&u=33169fc09&type=followers">
