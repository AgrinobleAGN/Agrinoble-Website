    ...
    <div class="col-md-3 sidebar rightcol">
		<div class="wow_content wow_side_loggd_usr">
			<div class="wow_side_loggd_usr_cvr">
				<img src="https://agrinoblelive.s3.amazonaws.com/upload/photos/d-cover.jpg?cache=0" alt="Ri Shi Cover Image">
			</div>
			<div class="wow_side_loggd_usr_hdr">
                <div class="avatar">
                    <img id="updateImage-74" alt="Ri Shi Profile Picture" src="https://agrinoblelive.s3.amazonaws.com/upload/photos/2021/06/JOJRbUBhZyb3TRKt1KSR_avatar.jpg?cache=0" >
                </div>
				<div class="title">
					<a id="user-full-name" data-ajax="?link1=timeline&u=3f697c044" href="https://agrinoble.com/3f697c044">Ri Shi</a>
					<p>@3f697c044</p>
				</div>
			</div>
			<ul class="wo_user_side_info">
				<li>
					<a class="menu_list" href="https://agrinoble.com/3f697c044" data-ajax="?link1=timeline&u=3f697c044">
						<span class="split-link"><b>posts</b></span>
						<span id="user_post_count">0</span>
					</a>
				</li>
													<li>
						<a class="menu_list" href="https://agrinoble.com/3f697c044/following" data-ajax="?link1=timeline&u=3f697c044&type=following">
							<span class="split-link"><b>Followers</b></span>
							<span>0</span>
						</a>
					</li>
					<li>
						<a class="menu_list" href="https://agrinoble.com/3f697c044/followers" data-ajax="?link1=timeline&u=3f697c044&type=followers">
