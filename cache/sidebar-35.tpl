    ...
    <div class="col-md-3 sidebar rightcol">
		<div class="wow_content wow_side_loggd_usr">
			<div class="wow_side_loggd_usr_cvr">
				<img src="https://agrinoblelive.s3.amazonaws.com/upload/photos/d-cover.jpg?cache=0" alt="Manish Sharma Cover Image">
			</div>
			<div class="wow_side_loggd_usr_hdr">
                <div class="avatar">
                    <img id="updateImage-35" alt="Manish Sharma Profile Picture" src="https://agrinoblelive.s3.amazonaws.com/upload/photos/2021/04/r7zWgSut4S9WDaN2TFtn_24_0116374bfaf41b43895bf665bb651d19_avatar.png?cache=0" >
                </div>
				<div class="title">
					<a id="user-full-name" data-ajax="?link1=timeline&u=flymediatechnology" href="https://agrinoble.com/flymediatechnology">Manish Sharma</a>
					<p>@flymediatechnology</p>
				</div>
			</div>
			<ul class="wo_user_side_info">
				<li>
					<a class="menu_list" href="https://agrinoble.com/flymediatechnology" data-ajax="?link1=timeline&u=flymediatechnology">
						<span class="split-link"><b>posts</b></span>
						<span id="user_post_count">1</span>
					</a>
				</li>
													<li>
						<a class="menu_list" href="https://agrinoble.com/flymediatechnology/following" data-ajax="?link1=timeline&u=flymediatechnology&type=following">
							<span class="split-link"><b>Followers</b></span>
							<span>0</span>
						</a>
					</li>
					<li>
						<a class="menu_list" href="https://agrinoble.com/flymediatechnology/followers" data-ajax="?link1=timeline&u=flymediatechnology&type=followers">
